...
import { sendMessage, getMessages, getUserConversations , getPendingRequests ,acceptConversation,
  rejectConversation,createOrGetChat, markMessagesRead,deleteMessagesForEveryone,  deleteSelectedMessages} from "../controller/MessageController.js";
...
router.post("/messages/read", isAuthenticatedUser, markMessagesRead);
