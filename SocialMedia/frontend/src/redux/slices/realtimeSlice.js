...
const realtimeSlice = createSlice({
  ...
  reducers: {
    ...
    markMessagesReadUI: (state, action) => {
      ...
      if (!state.readByConversation[conversationId]) state.readByConversation[conversationId] = {};

      messageIds.forEach((id) => {
        if (!state.readByConversation[conversationId][id]) state.readByConversation[conversationId][id] = [];
